...
model(layers.Input(shape=(608, 608, 3)))
print(model.summary())
...
# weights = np.ndarray(
#     shape=(-1,), dtype='int32', buffer=weights_file.read())
#
# print(weights.shape)
